...
// Example of basic CRUD operations of Deepak.DeepaksExtension.CoolCCT
	...
	)
{
	...
	return SCModel.extend({
		...
		name: 'Deepak.DeepaksExtension.CoolCCT'
	...
	,	get: function (id)
		{
			var list = nlapiGetContext().getSessionObject('coolcct_list');
	...
	,	update: function (data)
		{
			...
			if(data.internalid)
			{
				...
				nlapiGetContext().setSessionObject('coolcct_list', JSON.stringify(list));
				return task;
			}
			else
			{
