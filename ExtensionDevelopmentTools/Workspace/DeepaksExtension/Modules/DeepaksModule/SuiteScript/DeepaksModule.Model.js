...
// Example of basic CRUD operations of Deepak.DeepaksExtension.DeepaksModule
	...
	)
{
	...
	return SCModel.extend({
		...
		name: 'Deepak.DeepaksExtension.DeepaksModule'
	...
	,	get: function (id)
		{
			var list = nlapiGetContext().getSessionObject('deepaksmodule_list');
	...
	,	update: function (data)
		{
			...
			if(data.internalid)
			{
				...
				nlapiGetContext().setSessionObject('deepaksmodule_list', JSON.stringify(list));
				return task;
			}
			else
			{
