// Deepak.MyCoolExtension.CoolCCTView, this is the view your cct
// will load after dragged into the application

define('Deepak.MyCoolExtension.CoolCCT.View'
,	[
		'CustomContentType.Base.View'

	,	'deepak_mycoolextension_coolcct.tpl'
...
,	function (
	...
	,	deepak_mycoolextension_coolcct_tpl
	...
	)
{
	...
	return CustomContentTypeBaseView.extend({
		...
		template: deepak_mycoolextension_coolcct_tpl
